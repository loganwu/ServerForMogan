...
hi Normal		ctermbg=Black  ctermfg=grey guibg=Black		 guifg=lightgreen
hi Comment		term=bold	   ctermfg=DarkYellow   guifg=Orange
hi Constant		term=underline ctermfg=LightRed guifg=White	gui=NONE
...
hi Special		term=bold	   ctermfg=LightMagenta   guifg=magenta
